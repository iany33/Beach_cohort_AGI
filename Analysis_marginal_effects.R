...
mfx <- comparisons(m4.2, re_formula = NA, variables = "water_contact3", by = "log_e_coli_max_s", 
                   newdata = nd) |> posterior_draws()
...
comparisons(m4.2, re_formula = NA, variables = "water_contact3", by = "log_e_coli_max_s", 
